          ...
          <div className="flex-1 overflow-hidden px-4 md:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 h-full relative">
              ...
              >
                ...
                <RenderFieldArray id="projects" fields={fieldArrays.projects} label="Projects" name="projects" keys={["title", "description", "technologiesUsed"]} register={register} watch={watch} errors={errors} />
        ...
        <div className="max-w-5xl mx-auto space-y-4 animate-fadeIn pb-20 px-4">      
          ...
          <div className="flex justify-center md:justify-start -mb-2">
            <button 
              ...
              className="btn btn-ghost btn-xs text-slate-500 hover:text-white gap-2 px-2 hover:bg-transparent transition-all"
            >
