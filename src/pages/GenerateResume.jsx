            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start relative">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="lg:col-span-7 space-y-4 md:space-y-6">
                ...
                <FormSection id="identity" title="Identity">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="form-control md:col-span-2">
                      ...
                      <input {...register("personalInformation.fullName", { required: "Full Name is required" })} className={`input input-bordered h-9 bg-base-100 text-xs ${errors.personalInformation?.fullName ? 'border-error' : 'border-white/5'}`} placeholder="John Doe" />
                    </div>
                    <div className="form-control">
                      ...
                      <input {...register("personalInformation.title", { required: "Job Title is required" })} className={`input input-bordered h-9 bg-base-100 text-xs ${errors.personalInformation?.title ? 'border-error' : 'border-white/5'}`} placeholder="Software Engineer" />
                    </div>
                    <div className="form-control">
                      ...
                      <input {...register("personalInformation.email", { required: "Email is required" })} className={`input input-bordered h-9 bg-base-100 text-xs ${errors.personalInformation?.email ? 'border-error' : 'border-white/5'}`} placeholder="john@example.com" />
                    </div>
                    <div className="form-control">
                      ...
                      <input {...register("personalInformation.location", { required: "Location is required" })} className={`input input-bordered h-9 bg-base-100 text-xs ${errors.personalInformation?.location ? 'border-error' : 'border-white/5'}`} placeholder="New York, NY" />
                    </div>
                    <div className="form-control">
                      <label className="label-text mb-1.5 text-[9px] font-bold uppercase tracking-widest text-slate-500 ml-1">Phone Number</label>
                      <input {...register("personalInformation.phoneNumber")} className="input input-bordered h-9 border-white/5 bg-base-100 text-xs" placeholder="+1 234 567 890" />
                    </div>
                  </div>
                </FormSection>
                ...
                <FormSection id="summary" title="Professional Summary">
                  <textarea {...register("summary", { required: "Professional Summary is required" })} className={`textarea textarea-bordered w-full h-20 min-h-[80px] py-2 px-3 bg-base-100 text-xs leading-relaxed ${errors.summary ? 'border-error' : 'border-white/5'}`} placeholder="Brief overview of your career..." />
                </FormSection>
